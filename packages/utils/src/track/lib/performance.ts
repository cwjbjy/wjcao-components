 ...
 */
function normalizePerformanceRecord(e: any) {
 ...
 */
function traceResourcePerformance(performance: any) {
...
function init({ performanceFirstResource, performanceCore }: InitOption) {
 ...
 */
function tracePerformance(eventId: string, options: any) {
  const record = {
    triggerTime: Date.now(),
    url: window.location.href,
    ...options,
